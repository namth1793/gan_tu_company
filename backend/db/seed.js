...
const categories = [
  ...
  { name: 'Khuôn / Mold',    slug: 'khuon-mold',    icon: 'FaCubes',  description: 'Khuôn đúc giày dép chuyên dụng: khuôn đế cao su, khuôn đế EVA, khuôn khóa, khuôn carbon', sort_order: 6 },
];
...
const products = [
  ...
  // ── Khuôn / Mold (cat 6) ─────────────────────────────────────────
  {
    category_id: 6, code: 'KM-001',
    name: 'Khuôn Đế Cao Su Lưu Hoá',
    slug: 'khuon-de-cao-su-luu-hoa',
    description: 'Khuôn đúc đế giày cao su lưu hoá (vulcanized rubber), chế tác từ thép P20 hoặc nhôm 7075, độ bền cao, chịu nhiệt tới 180°C. Gia công CNC chính xác, hoa văn sắc nét, tuổi thọ 300.000–500.000 lần ép. Thiết kế theo mẫu hoặc theo file 3D của khách hàng.',
    specifications: '{"Vật liệu khuôn":"Thép P20 / Nhôm 7075","Nhiệt độ làm việc":"Tới 180°C","Tuổi thọ":"300.000–500.000 lần ép","Gia công":"CNC 5 trục","Lead time":"25–35 ngày","Tùy chỉnh":"Theo mẫu / file 3D"}',
    image_url: SEED('rubber-sole-mold-vulcanized'),
    price: 'Liên hệ', is_featured: 1,
  },
  {
    category_id: 6, code: 'KM-002',
    name: 'Khuôn Đế EVA Phun Ép',
    slug: 'khuon-de-eva-phun-ep',
    description: 'Khuôn đúc đế EVA phun ép (injection molding), nhôm hợp kim cao cấp, làm mát nhanh bằng kênh nước, cho ra đế nhẹ đồng đều, không bọt khí. Phù hợp đế thể thao, sandal, dép đi trong nhà. Hỗ trợ thiết kế kênh dẫn nhựa tối ưu.',
    specifications: '{"Vật liệu khuôn":"Nhôm hợp kim 7075","Công nghệ":"Injection Molding","Làm mát":"Kênh nước tuần hoàn","Kích thước":"Size 35–46 (hoặc theo yêu cầu)","Lead time":"20–30 ngày","Tùy chỉnh":"Theo mẫu / file 3D"}',
    image_url: SEED('eva-sole-injection-mold'),
    price: 'Liên hệ', is_featured: 1,
  },
  {
    category_id: 6, code: 'KM-003',
    name: 'Khuôn Khóa Giày (Buckle Mold)',
    slug: 'khuon-khoa-giay-buckle-mold',
    description: 'Khuôn đúc khóa giày (buckle) bằng kẽm hợp kim hoặc nhựa ABS/nylon. Thiết kế đa dạng: khóa bấm, khóa kéo thanh, khóa dây nhanh (quick-lace). Bề mặt mạ chrome, nickel hoặc sơn tĩnh điện theo yêu cầu. Độ chính xác cao, khớp lắp ráp chặt chẽ.',
    specifications: '{"Vật liệu khuôn":"Thép P20","Vật liệu sản phẩm":"Kẽm hợp kim / ABS / Nylon","Bề mặt":"Mạ chrome, nickel, sơn tĩnh điện","Kích thước":"10–50mm","Lead time":"20–30 ngày","Tùy chỉnh":"Theo bản vẽ / mẫu thực"}',
    image_url: SEED('shoe-buckle-clasp-mold'),
    price: 'Liên hệ', is_featured: 1,
  },
  {
    category_id: 6, code: 'KM-004',
    name: 'Khuôn Carbon Fiber Giày Thể Thao',
    slug: 'khuon-carbon-fiber-giay-the-thao',
    description: 'Khuôn tạo hình chi tiết carbon fiber dùng trong sản xuất đế giữa (midsole) và tấm carbon performance cho giày chạy bộ chuyên nghiệp. Chịu áp suất autoclave 6–8 bar, nhiệt 120–180°C. Gia công CNC từ nhôm Invar hoặc composite tool.',
    specifications: '{"Vật liệu khuôn":"Nhôm Invar / Composite tool","Áp suất làm việc":"6–8 bar","Nhiệt độ curing":"120–180°C","Độ dày sản phẩm":"0.5–3mm","Lead time":"35–45 ngày","Ứng dụng":"Midsole, tấm carbon giày chạy"}',
    image_url: SEED('carbon-fiber-shoe-mold-performance'),
    price: 'Liên hệ', is_featured: 0,
  },
];
...
const news = [
  ...
  {
    title: 'Khuôn đế giày – Lựa chọn vật liệu khuôn tối ưu cho từng loại đế',
    slug: 'khuon-de-giay-lua-chon-vat-lieu-toi-uu',
    excerpt: 'Thép P20, nhôm 7075 hay nhôm Invar? Hướng dẫn chọn vật liệu khuôn phù hợp với sản lượng, nhiệt độ và yêu cầu kỹ thuật cho từng loại đế giày.',
    content: 'Việc lựa chọn vật liệu khuôn đúng là yếu tố then chốt ảnh hưởng trực tiếp đến chất lượng sản phẩm và chi phí sản xuất. Thép P20 phù hợp cho khuôn cao su lưu hoá nhờ độ bền nhiệt cao. Nhôm 7075 là lựa chọn tối ưu cho khuôn EVA phun ép nhờ dẫn nhiệt nhanh, rút ngắn chu kỳ ép. Nhôm Invar dùng cho khuôn carbon composite vì hệ số giãn nở nhiệt thấp, đảm bảo độ chính xác kích thước khi curing ở nhiệt độ cao...',
    image_url: SEED('shoe-mold-material-selection'),
    is_featured: 0,
  },
  {
